function base64Wasm2WasmBinary(wasm_base64, compress = null){
...
function wasmBinary2WasmObjectURL(wasm_binary){
    return URL.createObjectURL(new Blob([wasm_binary], {type : 'application/wasm'}));
}

async function base64Wasm2WasmObjectURL(wasm_base64, compress = null){
    const binary = await base64Wasm2WasmBinary(wasm_base64, compress)
    return wasmBinary2WasmObjectURL(binary);
}

async function initBase64Wasm(wasm_raw_data, compress = null, imports = null){
